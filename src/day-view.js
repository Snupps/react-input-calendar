  ...
  (0, _createClass3.default)(DayView, [{
    ...
    value: function getDaysTitles() {
      ...
      return [0, 1, 2, 3, 4, 5, 6].map(function (i) {
        var weekday = now.weekday(i).format('dd').charAt(0);
    ...
    value: function render() {
      ...
      var days = this.getDays().map(function (item, i) {
        ...
        var _class2 = (0, _classnames2.default)({
          day: true,
          next: item.next,
          prev: item.prev,
          disabled: item.disabled,
        ...
        return _react2.default.createElement(_cell2.default, { classes: _class, key: i, value:  
          _react2.default.createElement('span', {className:"num"}, item.label )  
        });
      });
